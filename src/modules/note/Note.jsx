...
function Note() {
  const { notes, currentNoteId, handleDelete, Edit, cancelEdit } = useNoteContext();

  return (
    <div className='mx'>
      <div className="App w-[100%] flex flex-col items-center">
        <h1 className='text-center text-4xl p-5'>Notes</h1>
        {currentNoteId ? <FormEdit onCancel={cancelEdit} targetValue={notes !== null ? notes.filter(e => e.id === currentNoteId)[0] : null} /> : <FormTambah onCancel={cancelEdit} />}
